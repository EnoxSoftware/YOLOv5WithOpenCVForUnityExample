...
namespace YOLOv5WithOpenCVForUnityExample
{
    ...
    public class YOLOv5ObjectDetectionExample : MonoBehaviour
    {
        ...
        public string Model = "YOLOv5WithOpenCVForUnityExample/yolov5n.onnx";
        ...
        // Private Fields
        private YOLOv5ObjectDetector _objectDetector;
        ...
        private void InitializeInference()
        {
            ...
            try
            {
                ...
                if (UseSentisInference)
                {
                    _objectDetector = new YOLOv5ObjectDetector(
                        modelPath,
                        _classesFilepath,
                    ...
                    Debug.Log("YOLOv5ObjectDetector initialized (Sentis / DNN_BACKEND_UNITY_SENTIS, backend=" + YoloSentisBackendType + ").");
                }
                else
#endif
                {
                    _objectDetector = new YOLOv5ObjectDetector(
                        ...
                        NmsThreshold,
                        TopK);
                    Debug.Log("YOLOv5ObjectDetector initialized (OpenCV DNN).");
                }
            ...
            {
                Debug.LogWarning("YOLOv5ObjectDetectionExample InitializeInference failed: " + ex);
            }
        }
