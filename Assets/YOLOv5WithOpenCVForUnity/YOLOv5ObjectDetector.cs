...
namespace YOLOv5WithOpenCVForUnity.Worker
{
    ...
    /// This class provides functionality for object detection using the YOLOv5 model implemented with OpenCV's DNN module.
    /// Referring to:
    ...
    /// yolov7-tiny.onnx
    /// </summary>
    public class YOLOv5ObjectDetector : ProcessingWorkerBase
    {
        ...
        /// <summary>
        /// Initializes a new instance of the YOLOv5ObjectDetector class.
        /// </summary>
        ...
        public YOLOv5ObjectDetector(string modelFilepath, string classesFilepath, Size inputSize,
        ...
        protected virtual Mat PostProcess(List<Mat> outputBlobs, (double width, double height) originalSize)
        {
            ...
            using (Mat outputBlob_NxBoxConfClsconfs = outputBlob_0.reshape(1, num))
            {
                // pre-NMS
                PreNMS_BoxConfClsconfs_CXCYWHtoX1Y1X2Y2(outputBlob_NxBoxConfClsconfs, ref _preNMS_Nx6, _confThreshold, _topK);
            }
        ...
        protected virtual void PreNMS_BoxConfClsconfs_CXCYWHtoX1Y1X2Y2(Mat boxConfClsconfs, ref Mat preNMS_Nx6, float score_threshold, int top_k = 300)
        {
            ...
            ReadOnlySpan<float> allBoxConfClsconfs = _allBoxConfClsconfsBuffer.AsSpan(0, requiredBoxConfClsconfsLen);
